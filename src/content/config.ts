...
const projects = defineCollection({
  ...
  schema: z.object({
    ...
    relatedMoments: z.array(z.string()).default([]),
...
const anime = defineCollection({
  ...
  schema: z.object({
    ...
    siteScore: z.number().min(0).max(10).optional(),
    bangumiUserRate: z.number().min(0).max(10).optional(),
    bangumiCommunityScore: z.number().min(0).max(10).optional(),
    /** @deprecated: retained for older entries; use bangumiCommunityScore. */
    bangumiRate: z.number().min(0).max(10).optional(),
    ...
    longReview: z.string().optional(),
    favoriteCharacters: z.array(z.string()).default([]),
    relatedMusic: z.array(z.string()).default([]),
    relatedPosts: z.array(z.string()).default([]),
    relatedMoments: z.array(z.string()).default([]),
    customTags: z.array(z.string()).default([]),
    bangumiTags: z.array(z.string()).default([]),
    bangumiSummary: z.string().optional(),
    bangumiAirDate: z.string().optional(),
    bangumiRank: z.number().optional(),
    bangumiSyncedAt: z.string().optional(),
    manualHidden: z.boolean().default(false),
